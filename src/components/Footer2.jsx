...
export default function Footer2() {
  ...
  return (
    <div>
      <footer className="bg-gray-100">
        <div className="mx-auto max-w-5xl px-4  py-sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-2 max-w-md text-center leading-relaxed text-gray-500">
            © 2024 Ai ccernity marketing. Inspiring ideas and stories for your
            everyday life.
          </p>

          <ul className="mt-4 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
            {catagoriesData?.map((value) => (
              <Link href={`/category/${value.attributes.name}`} key={value.id}>
                <p
                  key={value.id}
                  className="text-gray-700 first-letter:capitalize hover:text-red-700 hover:font-semibold transition-all"
                >
          ...
          <ul className="mt-6 py-2 flex justify-center gap-6 md:gap-8">
            <li>
              <a
                href="#"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition-all hover:text-red-700"
              >
      ...
      {/* <footer className="bg-white border shadow-md text-gray-700 py-5">
